...
for (const statement of [
  sql`CREATE TABLE IF NOT EXISTS "game" (
	...
	"minimum_point_step" integer NOT NULL,
	"first_point" integer NOT NULL,
	"roll" integer NOT NULL,
	"enable_syakkinn_yakusoku_tegata" boolean NOT NULL,
	"yakusoku_tegata" integer NOT NULL,
	"enable_syokugyou" boolean NOT NULL,
	"enable_marry" boolean NOT NULL,
	"enable_items" boolean NOT NULL,
	"enable_myhome" boolean NOT NULL,
	"enable_kabukenn" boolean NOT NULL,
	"enable_hokenn_syoukenn" boolean NOT NULL
);
`,
