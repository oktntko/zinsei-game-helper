  ...
  <main class="flex flex-1 flex-col gap-2 overflow-y-auto p-2">
    ...
    <div class="ml-4 space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <InputCommafyNumber
          v-model.number="modelValue.yakusoku_tegata"
          required
          :step="modelValue.step"
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_syokugyou" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_marry" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_items" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_myhome" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_kabukenn" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
    ...
    <div class="space-y-1">
      <label class="flex cursor-pointer items-center justify-between">
        ...
        <input v-model="modelValue.enable_hokenn_syoukenn" type="checkbox" class="peer hidden" />
        <div
          class="peer relative h-6 w-11 rounded-full bg-gray-300 after:absolute after:start-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"
        ></div>
      </label>
